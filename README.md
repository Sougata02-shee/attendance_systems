...
# Project Overview
-> This is a Flask-based face recognition attendance system where users can register with their photos, and the system captures attendance using a webcam by matching faces with registered users. Attendance is recorded in an Excel sheet.
 # Workflow
